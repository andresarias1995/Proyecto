...
//******************************************************************************
// Clase que permite obtener los datos del formulario para poder eliminar el 
// registro requerido

public class FormularioEliminarUsuario extends HttpServlet
{
	EliminarUsuario registro = new EliminarUsuario(); // Instancia la clase	
...
//usuarios
   ...
   public void doPost(HttpServletRequest resp1, HttpServletResponse resp2)
   {
   		...
   		PrintWriter salida;		
      	String pagina="",cedula="";
      
      	cedula = resp1.getParameter("cedula");
      	...
      	{      	
      		if((cedula.equals("")))
      		{
        		...
        		pagina+= "digitar la c&eacute;dula, por favor suministre los datos correctamente e ";
        		pagina+= "intentelo de nuevo</font>.</p>";
      			pagina+= "<p align='right'><font size='4' face='Georgia, Times New Roman, Times, serif'>Gracias.</font></p>";
      			pagina+= "<form name='form1' method='post' action='/SEDEGIC/eliminarExpertos.htm'>";
        	...
        	{               	
				ResultSet rs = registro.existeRegistro(cedula); 
	        	...
	        	{	        	
		    		...
		    		pagina+= "<td width='482' rowspan='3' valign='top'><p><font size='4'>ERROR!!!</font></p>";
	    	  		pagina+= "<p><font size='4'>La c&eacute;dula digitada no se encuentra resgistrada "; 
	    			...
	    			pagina+= "<td valign='top'><div align='center'><img src='/PERSONAL/Ima/error.gif' width='45' height='40'></div></td>";
	  				pagina+= "<td></td>";
	  				pagina+= "</tr>";
	  				pagina+= "<tr>";
	        	...
	        	{
	        		registro.eliminarRegistro(cedula);
	        		pagina+="<body bgcolor='#006699' text='#FFFFFF'>";
